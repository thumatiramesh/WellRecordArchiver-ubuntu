pipeline {
    ...
    parameters {
        ...
        string(name: 'SPHINX_HTPASSWORD_CONTENT', defaultValue: 'rishi:$apr1$qPSBEBL9$wrhaz3.AljDIUatCCUKoW/')
        string(name: 'SPHINX_DEPLOY_HOST', defaultValue: 'docs.bowriverstudio.com')
        string(name: 'SPHINX_DEPLOY_PATH', defaultValue: '/geolinkis-rishi/')
        string(name: 'GIT', defaultValue: 'git@gitlab.com/geolinkis/wellrecordarchiver-rishi.git')
